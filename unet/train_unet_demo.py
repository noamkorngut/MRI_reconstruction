...
import fastMRI
sys.path.insert(0, '/tcmldrive/Noam/AIsap/MRI_reconstruction/fastMRI/fastmri/')
...
#sys.path.insert(0, '/tcmldrive/Noam/AIsap/MRI_reconstruction/fastMRI/fastmri/pl_modules/')
