...
def build_args(epochs=1):
    ...
    data_path = fetch_dir("knee_path", path_config) / 'Dataset/singlecoil_train' #'/home/noam.korngut/singlecoil_train'#'Dataset/train' #
    val_path = fetch_dir("knee_path", path_config) /'Dataset/singlecoil_val' #'/home/noam.korngut/singlecoil_val'#  'Dataset/val'#
    test_path = fetch_dir("knee_path", path_config) / 'Dataset/singlecoil_test'
    batch_size =   1
